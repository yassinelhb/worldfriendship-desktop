...
public class ProduitController implements Initializable {
    ...
    private void setNewProduct() throws FileNotFoundException{
        ...
        for (Produit produit : listProduit) {
            ...
            Image image = new Image( new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\assets\\img\\product\\"+produit.getFirstimg()));
    ...
    private void setTopCategorie() {
        ...
        String url = "file:/C:/xampp/htdocs/worldfriendship/web/assets/img/categorie/"+listCategorie.get(0).getPath();
        ...
        url = "file:/C:/xampp/htdocs/worldfriendship/web/assets/img/categorie/"+listCategorie.get(2).getPath();
        ...
        url = "file:/C:/xampp/htdocs/worldfriendship/web/assets/img/categorie/"+listCategorie.get(1).getPath();
        ...
        url = "file:/C:/xampp/htdocs/worldfriendship/web/assets/img/categorie/"+listCategorie.get(3).getPath();
        ...
        url = "file:/C:/xampp/htdocs/worldfriendship/web/assets/img/categorie/"+listCategorie.get(4).getPath();
