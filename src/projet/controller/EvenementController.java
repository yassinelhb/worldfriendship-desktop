...
/*
 ...
 /* RECHERCHER par lieu*/
    ...
    public void refreshAccueil() {
        ...
        try {
            ...
            for (Evenement evenement : dataAccueil) {
                ...
                Image image = new Image(new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\Evenement\\image\\affiches\\" + evenement.getAffiche_evenement()));
                ImageView affiche = new ImageView(image);
    ...
    private void afficherValeurSelectionner(ActionEvent event) {
        ...
        try {
            ...
            File file = new File("C:\\xampp\\htdocs\\worldfriendship\\web\\Evenement\\image\\affiches\\" + evenSelect.getAffiche_evenement());
            Image image = new Image(file.toURI().toString());
 ...
 /*System.out.println(evenement.getNom_evenement());
            ...
            Image image = new Image(new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\Evenement\\image\\affiches\\" + evenSelect.getAffiche_evenement()));
