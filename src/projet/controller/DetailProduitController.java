...
public class DetailProduitController implements Initializable {
    ...
    public void setData(Produit p) throws FileNotFoundException {
        ...
        color.setFill(col);
        image_1 = new Image(new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\assets\\img\\product\\" + produit.getFirstimg()));
        ...
        image_2 = new Image(new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\assets\\img\\product\\" + produit.getSecondimg()));
         
        imgView_2.setImage(image_2);
        image_3 = new Image(new FileInputStream("C:\\xampp\\htdocs\\worldfriendship\\web\\assets\\img\\product\\" + produit.getThirdimg()));
